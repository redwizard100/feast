...
export FEAST_BUILD_NUMBER=${CIRCLE_SHA1}
...
export FEAST_CORE_URL=build-${CIRCLE_SHA1}.feast.dragonin.me:80
export FEAST_SERVING_URL=build-${CIRCLE_SHA1}.feast.dragonin.me:80
