...
export FEAST_BUILD_NUMBER=${CIRCLE_BUILD_NUM}
export FEAST_IMAGE_TAG=1890cb04688a3e10f6de7305992e71ee7ba1793d
# export FEAST_IMAGE_TAG=${CIRCLE_SHA1}
export FEAST_WAREHOUSE_DATASET=feast_build_${CIRCLE_BUILD_NUM}
export FEAST_CORE_URL=build-${CIRCLE_BUILD_NUM}.feast.dragonin.me:80
export FEAST_SERVING_URL=build-${CIRCLE_BUILD_NUM}.feast.dragonin.me:80
export FEAST_RELEASE_NAME=feast-${CIRCLE_BUILD_NUM}
